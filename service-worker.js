const CACHE_NAME = "raindogs-shell-v44";
const SHELL = ["./", "./index.html", "./manifest.webmanifest", "./icon.svg", "./supabase-config.js?v=81", "./supabase-auth.js?v=86", "./supabase-data.js?v=104", "./push-client.js?v=83"];
