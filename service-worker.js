const CACHE_NAME = "raindogs-shell-v3";
const SHELL = ["./", "./index.html", "./manifest.webmanifest", "./icon.svg", "./supabase-config.js?v=81", "./supabase-auth.js?v=82", "./supabase-data.js?v=81", "./push-client.js?v=81"];
