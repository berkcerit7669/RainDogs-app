const CACHE_NAME = "raindogs-shell-v1";
const SHELL = ["./", "./index.html", "./manifest.webmanifest", "./icon.svg", "./supabase-config.js", "./supabase-auth.js", "./supabase-data.js", "./push-client.js"];
