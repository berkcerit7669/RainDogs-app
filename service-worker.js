const CACHE_NAME = "raindogs-shell-v27";
const SHELL = ["./", "./index.html", "./manifest.webmanifest", "./icon.svg", "./supabase-config.js?v=81", "./supabase-auth.js?v=85", "./supabase-data.js?v=100", "./push-client.js?v=81"];
