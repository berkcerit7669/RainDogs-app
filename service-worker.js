const CACHE_NAME = "raindogs-shell-v9";
const SHELL = ["./", "./index.html", "./manifest.webmanifest", "./icon.svg", "./supabase-config.js?v=81", "./supabase-auth.js?v=84", "./supabase-data.js?v=85", "./push-client.js?v=81"];
